...
def make_1step_sched(timesteps):
    ...
    noise_scheduler_1step.set_timesteps(timesteps=timesteps, device='cuda')
...
class DenoiseTurbo(torch.nn.Module):
    def __init__(self, pretrained_name=None, pretrained_path=None, ckpt_folder='checkpoints', lora_rank_vae=4, mv_unet=False, timestep=999):
        ...
        self.sched = make_1step_sched(timesteps=[timestep])
