...
from model_denoise import DenoiseTurbo
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prompt', type=str, default='denoise and restore', help='The prompt to be used')
    ...
    parser.add_argument('--timestep', type=int, default=99, help='Diffusion timestep')
